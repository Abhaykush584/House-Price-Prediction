...
def add_sidebar():
    ...
    st.sidebar.write("This AI App predicts the price of a house based on parameter inputs.")
...
# FIXED FUNCTION (where your error was)
def get_scaled_values(input_dict):
    ...
    # FIX: Convert all boolean columns to int
    ...
    for key, value in input_dict.items():
        ...
        # FIX: Convert booleans in input to int just in case
...
def get_radar_chart(input_data):
    ...
    categories = ['Longitude', 'Latitude', 'Housing Median Age', 'Total Rooms', 'Total Bedrooms',
                  'Population', 'Households', 'Median Income', '<1 Hour Ocean', 'Inland',
    ...
    fig.add_trace(go.Scatterpolar(
        r=[
            ...
            input_data['ocean_proximity_NEAR BAY'], input_data['ocean_proximity_NEAR OCEAN']
        ],
        theta=categories,
        fill='toself',
        name='Mean Value'
...
def main():
    ...
    with st.container():
        ...
        st.write("This App predicts the price of a house using a XGBRegressor model.")
    ...
    with col1:
        ...
        st.write("`This AI helps estimate house prices but should not replace expert evaluation.`")
